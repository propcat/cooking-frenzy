...
export const PurpleCar = forwardRef<Group, GroupProps>((props, ref) => {
  const { nodes, materials } = useGLTF('models/decoration/purple_car.glb', 'draco/');
...
useGLTF.preload('models/decoration/purple_car.glb', 'draco/');