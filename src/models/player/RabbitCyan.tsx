...
export const RabbitCyan = forwardRef<PlayerModelHandle, GroupProps & PlayerProps>(({ children, playerId, ...props }, ref) => {
  const groupRef = useRef<Group>(null);

  const { nodes, materials, animations } = useGLTF('models/player/rabbit_cyan.glb', 'draco/');
...
useGLTF.preload('models/player/rabbit_cyan.glb', 'draco/');