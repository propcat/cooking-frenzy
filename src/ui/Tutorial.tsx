...
export function Tutorial() {
  return (
    <Container>
      ...
      <Video src='videos/tutorial_1.mp4' poster='posters/tutorial_1.jpg' webkit-playsinline playsInline autoPlay loop/>

      <h1>How to chop ingredients</h1>
      Place ingredients on the cutting board and hold the right button to chop them.
      <Video src='videos/tutorial_2.mp4' poster='posters/tutorial_2.jpg' webkit-playsinline playsInline autoPlay loop/>
      ...
      <Video src='videos/tutorial_3.mp4' poster='posters/tutorial_3.jpg' webkit-playsinline playsInline autoPlay loop/>

      <h1>Chukaman steamer</h1>
      Place ingredients into the chukaman steamer using the right button.
      <Video src='videos/tutorial_4.mp4' poster='posters/tutorial_4.jpg' webkit-playsinline playsInline autoPlay loop/>

      <h1>Assembling you dish</h1>
      Combine the necessary ingredients in the same place to automatically create your dish.
      <Video src='videos/tutorial_5.mp4' poster='posters/tutorial_5.jpg' webkit-playsinline playsInline autoPlay loop/>
      ...
      <Video src='videos/tutorial_6.mp4' poster='posters/tutorial_6.jpg' webkit-playsinline playsInline autoPlay loop/>

      <h1>Throw food</h1>
      For some kitchen fun, hold an object (food, pot, or pan) with the right button. Adjust your aim and release to toss it around.
      <Video src='videos/tutorial_7.mp4' poster='posters/tutorial_7.jpg' webkit-playsinline playsInline autoPlay loop/>
    </Container>
  )
}
