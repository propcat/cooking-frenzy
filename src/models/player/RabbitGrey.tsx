...
export const RabbitGrey = forwardRef<PlayerModelHandle, GroupProps & PlayerProps>(({ children, playerId, ...props }, ref) => {
  const groupRef = useRef<Group>(null);

  const { nodes, materials, animations } = useGLTF('models/player/rabbit_grey.glb', 'draco/');
...
useGLTF.preload('models/player/rabbit_grey.glb', 'draco/');