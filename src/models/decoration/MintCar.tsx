...
export const MintCar = forwardRef<Group, GroupProps>((props, ref) => {
  const { nodes, materials } = useGLTF('models/decoration/mint_car.glb', 'draco/');
...
useGLTF.preload('models/decoration/mint_car.glb', 'draco/');