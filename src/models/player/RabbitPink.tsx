...
export const RabbitPink = forwardRef<PlayerModelHandle, GroupProps & PlayerProps>(({ children, playerId, ...props }, ref) => {
  const groupRef = useRef<Group>(null);

  const { nodes, materials, animations } = useGLTF('models/player/rabbit_pink.glb', 'draco/');
...
useGLTF.preload('models/player/rabbit_pink.glb', 'draco/');