...
export const BlueCar = forwardRef<Group, GroupProps>((props, ref) => {
  const { nodes, materials } = useGLTF('models/decoration/blue_car.glb', 'draco/');
...
useGLTF.preload('models/decoration/blue_car.glb', 'draco/');